class Quiz < ApplicationRecord
  ...
  validates :choices_4, presence: true, length: {minimum: 1, maximum: 10, message: "は1文字以上10文字以内で入力してください"}
  validates :correct_answer, presence: true, numericality: {greater_than_or_equal_to: 1, less_than_or_equal_to: 4, message: 'は1から4の数字で入力してください'}
